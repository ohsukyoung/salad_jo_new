...
//        fis1.close();
    ...
    public void ad_add() throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            while (true) {
                System.out.print("\t▶ 조합에 들어갈 재료의 구분번호 입력 (0: 종료) : ");
            ...
            // 할인율 계산
            double r_discount = 100 - ((r_price / totalPrice) * 100);
            ...
            if (isDuplicate) {
                ...
                if (x == 'Y' || x == 'y') {
                    ...
                    MasterRc masterRc = new MasterRc(r_checkNumber, ProductType.RCMND, r_name, totalCalorie, r_price, selectedProducts, r_discount, r_count);
                    list2.add(masterRc);
